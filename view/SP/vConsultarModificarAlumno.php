                ...
                <fieldset>
                    <table>
                        ...
                        <td class="d-flex justify-content-start">
                            <label for="codAlumnoAEditar">Código de Departamento:</label>
                        </td>
                        <td>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-start">
                                <label for="T09_NombreAlumno">Nombre del alumno:</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <!-- Descripcion Departamento Obligatorio -->
                            <td class="d-flex justify-content-start">
                                <label for="T09_ApellidosAlumno">Apellido del alumno:</label>
                            </td>
                            <td>
                                                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                        ...
                        <tr>
                            <!-- Descripcion Departamento Obligatorio -->
                            <td class="d-flex justify-content-start">
                                <label for="T09_FechaNacimiento">Fecha de nacimiento:</label>
                            </td>
                            <td>
                                                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-start">
                                <label for="grupoAlumnoAEditar">Grupo:</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-start">
                                <label for="T09_ImporteMatricula">Importe de la matricula:</label>
                            </td>
                            <td>
                                                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
