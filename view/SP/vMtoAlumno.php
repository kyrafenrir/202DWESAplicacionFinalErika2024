    ...
    <div class="row mb-2">
        <div class="col text-center">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button class="botones" role="button" aria-disabled="true" type="submit" name="buscaAlumnoPorNomb">Buscar</button></td>
                            </tr>
                            <tr>
            ...
            if ($aAlumnosVista != null) {
                ...
                echo ("<tfoot ><tr style='background-color: black; color:white;'><td colspan='10'>Número de registros en la tabla Alumnos: " . $numeroDeRegistrosConsulta . '</td></tr></tfoot>');
                echo ("</table>");
                echo ("</div>");
            }
            ?>
    ...
    <div class="row">
        <div class="col grupoDeBotones">
            <form name="indexMtoAlumnos" method="post">
                ...
                <button class="botones" role="button" aria-disabled="true" type="submit" name="salirAlumnos">Salir</button>
            </form>
        </div>
    </div>
</div>